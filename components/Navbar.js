    ...
    <nav className="absolute top-0 w-full z-50 px-6 sm:px-12 py-6 bg-transparent">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
            ...
            <ul className="flex flex-col p-4 mt-4 backdrop-blur-lg  border border-dark md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0">
                <li>
                <a href="/home" className="block py-2 pr-4 pl-3 text-white bg-dark  md:bg-transparent md:text-strong md:p-0" aria-current="page">Home</a>
                </li>
                <li>
                    ...
                    <div id="dropdownNavbar" className="hidden z-10 p-6 w-max font-normal bg-soft border border-dark divide-y divide-gray-100 shadow-2xl" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style={{ position: "absolute", inset: "auto 48px auto auto", margin: "0px", transform: "translate3d(0px, 11px, 0px)" }}>
                        ...
                        <li>
                            <a href="module-1" className="block py-2 px-4 hover:bg-light ">1 - Cloud Concepts Overview</a>
                        </li>
                        <li>
                            <a href="module-2" className="block py-2 px-4 hover:bg-light">2 - Cloud Economics and Billing</a>
                        </li>
                        <li>
                            <a href="module-3" className="block py-2 px-4 hover:bg-light">3 - AWS Global Infrastructure Overview</a>
                        </li>
                        <li>
                            <a href="module-4" className="block py-2 px-4 hover:bg-light">4 - AWS Cloud Security</a>
                        </li>
                        <li>
                            <a href="module-5" className="block py-2 px-4 hover:bg-light">5 - Networking and Content Delivery</a>
                        </li>
                        <li>
                            <a href="module-6" className="block py-2 px-4 hover:bg-light">6 - Compute</a>
                        </li>
                        <li>
                            <a href="module-7" className="block py-2 px-4 hover:bg-light">7 - Storage</a>
                        </li>
                        <li>
                            <a href="module-8" className="block py-2 px-4 hover:bg-light">8 - Databases</a>
                        </li>
                        <li>
                            <a href="module-9" className="block py-2 px-4 hover:bg-light">9 - Cloud Architecture</a>
                        </li>
                        <li>
                            <a href="module-10" className="block py-2 px-4 hover:bg-light">10 - Auto Scaling and Monitoring</a>
                        </li>
                        </ul>
                ...
                <li>
                    <div className="py-2 pr-4 pl-3 text-dark text-opacity-50 flex flex-row justify-between items-center   md:bg-transparent md:text-strong md:p-0" aria-current="page">
                        <p>Logout</p>
                        <SignOutButton />                    
                    </div>
                </li>
